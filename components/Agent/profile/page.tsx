  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      if (requests && !requestsError) {
        ...
        totalPoints = totalWaste * 10; // Simulasi poin agen
      }
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-3">
              <Button variant="outline" onClick={() => router.push("/agent/tasks")}>
                Tugas Aktif
              </Button>
              <Button variant="outline" onClick={() => router.push("/agent/history")}>
                Lihat Riwayat
              </Button>
            </CardContent>
          </Card>
