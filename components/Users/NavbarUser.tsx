        ...
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                onClick={() => setIsProfileOpen(!isProfileOpen)}
                className="w-10 h-10 bg-slate-100 text-slate-600 rounded-full flex items-center justify-center border border-slate-200 overflow-hidden shadow-sm hover:border-emerald-500 transition-colors"
              >
                <User className="w-5 h-5" />
              </button>
