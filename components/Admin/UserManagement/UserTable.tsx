...
export default function UserTable() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-3 font-sans">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-6">
        <div className="space-y-1">
          ...
          <p className="text-slate-500 text-sm font-medium">
            Manajemen data {activeTab === "user" ? "masyarakat" : "agent"} dan
      ...
      <Card className="mt-5 border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[24px] overflow-hidden bg-white">
        {/* Toolbar */}
              ...
              <tbody className="divide-y divide-slate-50">
                {filteredUsers.length === 0 ? (
                  <tr>
                    ...
                    >
                      Tidak ada data{" "}
                      {activeTab === "user" ? "masyarakat" : "agent"}
                      {statusFilter !== "semua" &&
                  ...
                  filteredUsers.map((user) => (
                    ...
                    >
                      ...
                      <td className="px-8 py-5">
                        <Badge
                          className={`rounded-lg px-2.5 py-1 font-bold text-[10px] uppercase shadow-none border-none ${
                            user.status === "Aktif"
