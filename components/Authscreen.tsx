    ...
    <div className="relative min-h-svh w-full bg-slate-50 overflow-hidden">
          ...
          <div className={cn("absolute inset-0 bg-emerald-950 transition-opacity duration-1000 ease-in-out", !isLogin ? "opacity-100" : "opacity-0")}>
            ...
            <div className={cn("absolute bottom-0 left-0 right-0 p-16 text-white transition-all duration-700 delay-300", !isLogin ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
              ...
              <p className="text-emerald-100/80 text-lg max-w-md">
                Daftarkan dirimu sekarang, mulai pilah sampahmu, dan raih keuntungan nyata dari setiap aksi peduli lingkungan.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative w-1/2 h-full overflow-hidden">
          <div className={cn("absolute inset-0 bg-emerald-950 transition-opacity duration-1000 ease-in-out", isLogin ? "opacity-100" : "opacity-0")}>
            ...
            <div className={cn("absolute bottom-0 left-0 right-0 p-16 text-white transition-all duration-700 delay-300", isLogin ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
              <div className="flex items-center gap-2 mb-4">
                <div className="h-1 w-10 bg-emerald-400 rounded-full"></div>
                <span className="text-emerald-300 font-semibold text-sm uppercase tracking-wider">Ubah Sampah Jadi Berkah</span>
              </div>
              <h2 className="text-4xl font-bold mb-4 leading-tight">
                Daur Ulang & <br />
              ...
              <p className="text-emerald-100/80 text-lg max-w-md">
                Tukarkan sampahmu menjadi poin berharga yang bisa langsung digunakan untuk berbagai keperluan sehari-hari.
              </p>
            </div>
          </div>
          <div className={cn("absolute inset-0 bg-slate-50 transition-opacity duration-1000 ease-in-out", !isLogin ? "opacity-100" : "opacity-0")} />
      ...
      <div className={cn(
        ...
        <div className="flex flex-1 items-center justify-center relative w-full mt-4">
          <div className={cn("absolute w-full max-w-sm transition-all duration-700 ease-in-out", isLogin ? "opacity-100 translate-x-0 pointer-events-auto delay-200" : "opacity-0 -translate-x-8 pointer-events-none")}>
